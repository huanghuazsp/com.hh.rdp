...
public class EditTreeJspTemplate
{
  ...
  protected final String TEXT_4 = NL + "<script type=\"text/javascript\">" + NL + "\tvar params = $.hh.getIframeParams();" + NL + "\tvar width = 600;" + NL + "\tvar height = 450;" + NL + "\tvar objectid = '";
  ...
  protected final String TEXT_7 = "-saveTree', {" + NL + "\t\t\t\tdata : formData," + NL + "\t\t\t\tcallback : function(result) {" + NL + "\t\t\t\t\tif (result.success!=false) {" + NL + "\t\t\t\t\t\tcallback(formData);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t});" + NL + "\t\t});" + NL + "\t}" + NL + "" + NL + "\tfunction findData(objid) {" + NL + "\t\tif (objid) {" + NL + "\t\t\tRequest.request('";
  protected final String TEXT_8 = "-";
  protected final String TEXT_9 = "-findObjectById', {" + NL + "\t\t\t\tdata : {" + NL + "\t\t\t\t\tid : objid" + NL + "\t\t\t\t}," + NL + "\t\t\t\tcallback : function(result) {" + NL + "\t\t\t\t\t$('#form').setValue(result);" + NL + "\t\t\t\t}" + NL + "\t\t\t});" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\tfunction newData(params) {" + NL + "\t\tparams.expanded=0;" + NL + "\t\t$('#form').setValue(params);" + NL + "\t}" + NL + "" + NL + "\tfunction init() {" + NL + "" + NL + "\t}" + NL + "</script>" + NL + "</head>" + NL + "<body>" + NL + "\t<div xtype=\"hh_content\">" + NL + "\t\t<form id=\"form\" xtype=\"form\" class=\"form\">" + NL + "\t\t\t<span xtype=\"text\" config=\" hidden:true,name : 'id'\"></span>" + NL + "\t\t\t<table xtype=\"form\" width=80% align=center>" + NL + "\t\t\t\t<tr>" + NL + "\t\t\t\t\t<td xtype=\"label\">名称：</td>" + NL + "\t\t\t\t\t<td><span xtype=\"text\" config=\" name : 'text',required :true\"></span></td>" + NL + "\t\t\t\t</tr>" + NL + "\t\t\t\t<tr>" + NL + "\t\t\t\t\t<td xtype=\"label\">上级节点：</td>" + NL + "\t\t\t\t\t<td><span id=\"node_span\" xtype=\"selectTree\"" + NL + "\t\t\t\t\t\tconfig=\"name: 'node' , findTextAction : '";
